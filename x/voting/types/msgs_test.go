...
// TestMsgValidateBasic_LengthBounds covers the case where the election title/options and the cast-vote
// nullifier are length-bounded so a one-time fee cannot store an unbounded blob.
