...
// TestMsgRequestFxEntry_ValidateBasic_License covers the case where an fx onboarding request must carry a non-empty, bounded license (mirroring MsgRegisterInstitution).
